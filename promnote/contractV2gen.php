...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $retainer_fee = sanitizeInput($_POST['retainer_fee']);
    $initial_payment = sanitizeInput($_POST['initial_payment']);
    $remaining_balance = $retainer_fee - $initial_payment;
    $monthly_payment = sanitizeInput($_POST['monthly_payment']);
    $months = sanitizeInput($_POST['months']);
    $agreement_date = date('jS \d\a\y \of F, Y');

    // Sanitize the new variables passed for payments
    $total_payments = sanitizeInput($_POST['total_payments']);
    $first_payment = sanitizeInput($_POST['first_payment']);
    $payment_day = sanitizeInput($_POST['payment_day']);
